...
|---|---|---|---|
| 1 | $43.3M open pipeline with 60% win rate | Strong pipeline base; proven ability to close | Maintain qualification standards; protect win rate as pipeline scales |
| 2 | $13M (27%) accumulated in Discovery stage | Deals stalling — clients need support progressing to Specification | Sales enablement at Discovery → Specification; provide playbooks and scoping tools |
| 3 | Only 18% of pipeline in "Commit" forecast category | Forecast accuracy at risk; most pipeline loosely categorized | Enforce forecast category updates at each stage gate |
| 4 | Referral is the #1 pipeline source by value ($10M) | Relationship-driven channels drive the largest revenue pool | Expand referral and partner programs; incentivize introductions |
| 5 | Cold Call: high volume (19 leads) but low quality (58% Cold-rated) | Lead quality dilution; wasted follow-up effort | Shift Cold Call strategy from volume to qualification |
| 6 | Hotels underperforms at $20M avg revenue vs. $29–31M for peers | Low revenue efficiency per account in this vertical | Investigate Hotels deal sizing; consider reallocating coverage to higher-ROI verticals |
| 7 | David Okafor + Emily Watson carry 43% of all deals and 44% of pipeline | Concentration risk and best-practice opportunity | Document top-performer workflows; rebalance workload to develop other reps |
| 8 | 52% of leads still in "New" status | Delayed engagement risks pipeline generation | Implement SLAs; auto-assign Hot leads for immediate outreach |
